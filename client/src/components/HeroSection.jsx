...
const HeroSection = () => {
  return (
    <div
      ...
      className="flex flex-col items-end mt-20 w-full"
    >
      <div className="flex flex-col gap-6 bg-black text-end p-6 w-full animate__animated  animate__fadeInLeft">
        <h1 className="text-[#d6dce5] text-4xl sm:text-6xl font-bold">
      ...
      <div className="flex justify-between items-center w-full">
        <p className="bg-[#d6dce5] py-2 px-4 text-2xl sm:text-3xl font-bold animate__animated animate__fadeInLeft">
          حلول تقنية عقارية
        </p>
